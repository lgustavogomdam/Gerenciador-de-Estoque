 ...
 * @author gugag
 */
public class tela_cadastroPedido extends javax.swing.JDialog {

    private InterfaceManager ger;
    
    public tela_cadastroPedido(java.awt.Frame parent, boolean modal, InterfaceManager ger) {
        super(parent, modal);
        this.ger = ger;
        initComponents();
    }

    private tela_cadastroPedido(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jLabel25.setText("Cadastro de Pedido");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(147, 0, 255), 2, true), "Conteúdo do Pedido", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14), new java.awt.Color(0, 255, 255))); // NOI18N
